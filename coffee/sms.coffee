...
따라서 내용증명서를 발송한 후, 서울 광진경찰서와 법적 절차를 통한 손해배상청구를 진행할 예정입니다. 꼭 반납 부탁 드립니다. 감사합니다.'''
    macro5:
      text: '온라인 배송 후 안내'
      msg:  '[열린옷장] 00님, 송장번호:CJ대한통운/1234-5678-9000 반납 시, 받은 상자에 담아 보내주세요. ^^'
    macro6:
      text: '온라인 입금 안내'
      msg:  '[열린옷장] 결제금액:00000원입니다. 금일 00시까지 입금해주세요. 국민은행 205701-04-269524'
    macro7:
      text: '온라인 자동 취소 고지'
      msg:  '[열린옷장] 00님 금일 00시까지 온라인 대여 입금 확인이 안 될 경우 발송 취소 됨을 알립니다.'
