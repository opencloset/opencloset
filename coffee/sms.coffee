$ ->
  macros =
    ...
    macro4:
      text: '내용 증명'
      msg: 'xxx님 열린옷장 대여기간이 xx일 연체되었습니다. xx일 금요일까지 반납이 되지 않을 시, 반납의사가 없다고 판단되어 채무불이행과 횡령죄가 성립됩니다. 따라서 내용증명서를 발송한 후, 서울 광진경찰서와 법적 절차를 통한 손해배상청구를 진행할 예정입니다. 꼭 반납 부탁 드립니다. 감사합니다.'
