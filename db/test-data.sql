...
INSERT INTO `cloth` (`id`,`no`,`bust`,`waist`,`arm`,`length`,`category_id`,`top_id`,`bottom_id`,`donor_id`,`status_id`,`gender`,`color`,`compatible_code`) VALUES 
...
-- 대여중인거
INSERT INTO `cloth` (`id`,`no`,`bust`,`waist`,`arm`,`length`,`category_id`,`top_id`,`bottom_id`,`donor_id`,`status_id`) VALUES (6,'JCK00002', 99, NULL, 55, NULL, 1, NULL, NULL, 1, 2), (7,'PTS00002', NULL, 82, NULL, 112, 2, NULL, NULL, 1, 2);
