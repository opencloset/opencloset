...
INSERT INTO `donor`
  (`id`,`donation_msg`,`comment`,`create_date`)
VALUES
  (1,'잘입으셈','열린옷장대표1',NOW()),
  (2,'후후후후','열린옷장대표2',NOW());
...
INSERT INTO `guest`
  (`id`,`chest`,`waist`,`arm`,`length`,`height`,`weight`,`purpose`,`domain`,`create_date`,`visit_date`,`target_date`)
VALUES
  (3,93,78,51,102,168,59,'입사면접','software',NOW(),NOW(),DATE_ADD(NOW(), INTERVAL 3 day));

INSERT INTO `order` (`id`,`guest_id`,`status_id`,`rental_date`,`target_date`,`return_date`,`price`,`discount`,`comment`,`payment_method`,`staff_name`,`purpose`,`chest`,`waist`,`arm`,`length`) VALUES (1,3,2,'2013-10-18','2013-10-21',NULL,20000,0,NULL,'현금','김소령','입사면접',95,78,60,105);

INSERT INTO `cloth_order` (`cloth_id`,`order_id`) VALUES (6,1), (7,1);

INSERT INTO `satisfaction` (`guest_id`,`cloth_id`,`chest`,`waist`,`arm`,`top_fit`,`bottom_fit`,`create_date`) VALUES (3,6,1,2,3,4,5,'2013-10-18');
COMMIT;
