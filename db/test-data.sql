...
INSERT INTO `guest` (`id`,`name`,`email`,`phone`,`gender`,`address`,`age`,`chest`,`waist`,`arm`,`length`,`height`,`weight`,`create_date`,`visit_date`,`domain`,`target_date`) VALUES (1,'홍형석','aanoaa@gmail.com','01031820000',1,'서울시 동작구 사당동',32,93,78,51,102,168,59,'2013-01-03','2013-01-03','silex - 컴퓨터프로그램','2013-01-04');
