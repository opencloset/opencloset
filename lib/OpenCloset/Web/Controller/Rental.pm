...
sub rental2returned {
    ...
    $v->optional('compensation_price');
    $v->optional('compensation_discount');
    $v->optional('codes');
    ...
    my $compensation_price    = $v->param('compensation_price');
    my $compensation_discount = $v->param('compensation_discount');
